...
function sumArray(sumArr) { //eslint-disable-line
  ...
  {
      result1=sum(result1,testArray[i])[0];
  }
  
  return[result1,`${testArray[0]},${testArray[1]},${testArray[2]} was passed in as an array of numbers, and ${result1} is their sum.`];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  let result2=multiply(testArray[0],testArray[1])[0];
  result2=multiply(result2,testArray[2])[0];
...
function multiplyAnyArray([a,b,c,d,e]) { //eslint-disable-line
  ...
  result3=multiply(result3,c)[0];
  result3=multiply(result3,d)[0];
  result3=multiply(result3,e)[0];
  return[result3,`The numbers ${a},${b},${c},${d},${e} have a product of ${result3}.`]
}
