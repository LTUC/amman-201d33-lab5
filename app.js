...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  let result2=sum(result1,c)[0];
  let result3=multiply(a,b)[0];
  let result4= multiply(result3,c)[0];
...
let mj=0;
  ...
  for (let i = 0; i < sumArr.length ; i++) {
    ...
    mj = sum(mj,sumArr[i])[0];
    
  }
return [mj,`${sumArr} was passed in as an array of numbers, and ${mj} is their sum.`];
}
...
return [jj,`The numbers ${multArr} have a product of ${jj}.`];
