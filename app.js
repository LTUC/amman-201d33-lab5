...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  let finalResult1=sum(result1,c)[0];
  let result2=multiply(a,b)[0];
  let finalResult2=multiply(result2,c)[0];
  return [finalResult1,finalResult2,a +' and ' + b +' and '+ c +' sum to '+finalResult1+'.','The product of '+ a +' and '+ b+ ' and '+ c+ ' is '+ finalResult2+'.'];
}
