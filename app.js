...
let sumresult2=sum(sumresult[0],c)

let resultmulty =multiply(a, b);
let resultmulty2 =multiply(resultmulty[0],c)
...
function multiplyArray(multArr) { //eslint-disable-line
  let mularrresult=multiply(testArray[0],testArray[1])
  let mularrresult2=multiply(mularrresult[0],testArray[2]) 
  return[mularrresult2[0],"The numbers 2,3,4 have a product of 24."]
}
